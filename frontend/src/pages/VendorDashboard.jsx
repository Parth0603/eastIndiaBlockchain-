...
const VendorDashboard = () => {
  ...
  const generateNewPaymentCode = () => {
    ...
    const newCode = timestamp.slice(-8).toUpperCase();
        ...
        <div className="bg-white rounded-3xl shadow-lg overflow-hidden mb-8">
          ...
          <div className="p-6">
            ...
            <div className="text-center mb-6">
              ...
              {/* QR Code Placeholder */}
              <div className="w-48 h-48 bg-gray-100 border-2 border-dashed border-gray-300 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <div className="text-center">
                  <div className="text-6xl mb-2">📱</div>
                  <div className="text-sm text-gray-500">QR Code</div>
                  <div className="text-xs text-gray-400">Scan with beneficiary app</div>
                </div>
              </div>
